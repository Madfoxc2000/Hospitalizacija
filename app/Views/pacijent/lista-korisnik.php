<div class="administrator-table-content">
    ...
    <div class="table-form-container">
        ...
        <div class="filter-form-container pacijent">
            ...
            <div class="mt-2">
                <button type="button" class="btn btn-sm btn-outline-warning w-100 btn-stampa-print" onclick="stampajListu('pacijenti-korisnik-body', 'Списак пацијената')">Штампај</button>
            </div>
        </div>
