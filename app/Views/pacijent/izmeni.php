...
<div class="input-container">
    <fieldset>
        <legend>Пол:</legend>
        <div><input type="radio" name="Pol" value="Мушко"><label>Мушко</label></div>
        <div><input type="radio" name="Pol" value="Женско"><label>Женско</label></div>
        <div><input type="radio" name="Pol" value="Друго" checked><label>Друго</label></div>
    </fieldset>
</div>
