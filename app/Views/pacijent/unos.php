...
<div class="col-12 col-sm-6 col-md-4">
    <label class="form-label" for="BrojIstorijeBolesti">Број историје болести<span aria-label="required">*</span></label>
    <input type="text" class="form-control" name="BrojIstorijeBolesti" placeholder="XX123" required>
...
<div class="col-12 col-sm-6 col-md-4">
    <label class="form-label" for="ImeJednogRoditelja">Имеједног родитеља<span aria-label="required">*</span></label>
...
<div class="col-12" id="pacijent-status"></div>
