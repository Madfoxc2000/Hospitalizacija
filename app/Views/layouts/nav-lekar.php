...
<nav class="navbar navbar-dark py-0 sticky-top" style="background-color: rgba(66,135,245,0.2); height: 10vh;">
    <div class="container-fluid">
        <span class="navbar-brand mb-0"><h3 class="mb-0">Лекар: <b><?php echo htmlspecialchars($korisnik); ?></b></h3></span>
        <div class="d-flex gap-3 align-items-center">
            ...
            <picture style="cursor:pointer;" onclick="window.location.href='pacijent-lista-korisnik';">
                ...
                <img src="images/person.png" alt="Листа пацијената" class="rounded nav-icon-hover" />
            </picture>

            <!-- Admitted patients + hospitalization list -->
            <div class="dropdown">
                <picture id="M" style="cursor:pointer; "onclick="window.location.href='primljeni-pacijenti';">
