<?php
class Transakcija{
//Služi da obezbedi funkcije za rad sa transakcijama.
// atributi
...
// ------- konstruktor
public function __construct($NovaOtvorenaKonekcija, $NovaVerzijaMySQLNaredbi)
{
	$this->OtvorenaKonekcija=$NovaOtvorenaKonekcija;
	$this->VerzijaMySQLNaredbi=$NovaVerzijaMySQLNaredbi;
}
