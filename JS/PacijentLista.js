...
/* ====================================================== Print section =====================================*/
const prijemButtons = document.querySelectorAll("[prijem]");
prijemButtons.forEach(button => {
  button.addEventListener("click", function() {
    const formId = button.getAttribute("prijem");
    submitPrijemForm(formId);
  });
});


 // Get references to elements
 function submitPrijemForm(formId) {
   document.getElementById(formId).submit(); // Submit the specific form
 }
